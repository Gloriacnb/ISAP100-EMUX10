...
typedef struct
{
  volatile UNS_32 emccontrol;	//0000
  volatile UNS_32 emcstatus;
  volatile UNS_32 emcconfig;	//0008
  volatile UNS_32 reserved1 [5];//000c ~ 001c
  volatile UNS_32 emcdynamiccontrol;//0020
  volatile UNS_32 emcdynamicrefresh;//0024
  volatile UNS_32 emcdynamicreadconfig;//0028
  volatile UNS_32 reserved2;
  volatile UNS_32 emcdynamictrp;	//0030
  volatile UNS_32 emcdynamictras;
  volatile UNS_32 emcdynamictsrex;
  volatile UNS_32 reserved3 [2];	//003c ~ 0040
  volatile UNS_32 emcdynamictwr;
  volatile UNS_32 emcdynamictrc;
  volatile UNS_32 emcdynamictrfc;
  volatile UNS_32 emcdynamictxsr;	//0050
  volatile UNS_32 emcdynamictrrd;
  volatile UNS_32 emcdynamictmrd;
  volatile UNS_32 emcdynamictcdlr;
  volatile UNS_32 reserved4 [8];	//0060 ~ 007c
  volatile UNS_32 emcstaticextendedwait;//0080
  volatile UNS_32 reserved5 [31];		//0084 ~
  volatile UNS_32 emcdynamicconfig0;	//0100
  volatile UNS_32 emcdynamicrascas0;
  volatile UNS_32 reserved6 [6];
  volatile UNS_32 emcdynamicconfig1;	//0120
  volatile UNS_32 emcdynamicrascas1;	//0124
