...
INT_32 sdcard_open(void *ipbase, INT_32 arg);

/* Close the SD card controller driver */
STATUS sdcard_close(INT_32 devid);

/* SD card controller driver configuration block */
STATUS sdcard_ioctl(INT_32 devid, INT_32 cmd, INT_32 arg);

/* SD card controller driver read function (stub only) */
INT_32 sdcard_read(INT_32 devid, void *buffer, INT_32 max_bytes);

/* SD card controller driver write function (stub only) */
INT_32 sdcard_write(INT_32 devid, void *buffer, INT_32 n_bytes);
