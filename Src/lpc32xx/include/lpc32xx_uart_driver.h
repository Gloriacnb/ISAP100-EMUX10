...
STATUS uart_ioctl(INT_32 devid, INT_32 cmd, INT_32 arg);

/* UART read function */
INT_32 uart_read(INT_32 devid, void *buffer, INT_32 max_bytes);

/* UART write function */
INT_32 uart_write(INT_32 devid, void *buffer, INT_32 n_bytes);
